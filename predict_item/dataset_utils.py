...
class SequenceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if len(inp) > self.max_length:
            ...
            # inp = inp + [self.padding_value] * (self.max_length - len(inp)) # 右パディング
...
def get_val_or_test_dataloader(padding_value, input_file_path, output_file_path, batch_size=32, max_length=20):
    dataset = SequenceDataset(input_file_path, padding_value,  output_file_path, max_length=max_length)
